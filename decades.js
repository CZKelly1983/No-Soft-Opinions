...
(function () {
  ...
  const DECADE_ESSAYS = {
    ...
    '2010s': {
      ...
      essay: `Two hundred and sixty-three films — more than any other decade, and a dataset that reflects the explosion in production volume rather than a concentration of significance. The 2010s average score of 47.2 is the lowest of any decade except the 2020s, and the average F2 of 45.5 falls 7.2 points below F1 — the widest popular-over-filmmaker gap in the dataset. Parasite leads the decade at 75.3, the only film in the 2010s top five with a higher F2 than F1, a film where critical consensus and filmmaker respect converge on something that also reached mainstream audiences. Mad Max: Fury Road at 73.5 has the decade's second-highest F2 at 76.5: an action film the filmmaker community treats as a formal achievement. The Superhero genre has 31 entries in the 2010s — more than the entire dataset has Horror films — and its most contested entries (Transformers: Age of Extinction vol: 15.8, Pirates: On Stranger Tides vol: 15.1) show the decade's most extreme F1/F2 gaps. The D6 cultural footprint finding is at its starkest here: the post-2015 mean D6 across the whole dataset is 19.7. Films earn enormous box office scores and leave almost nothing permanently detached from their release moment. The 2010s produced a lot of cinema. The data is honest about how much of it will last.`
    },
    '2020s': {
      headline: 'Too Early to Know — But the Data Has Opinions',
      essay: `Seventy-eight films through 2025, and the decade the index is most explicitly cautious about. All 2020s scores should be read as provisional — the Long View framework cannot fully function on films whose long view is still being written. The average score of 46.1 is the lowest in the dataset, and the F3 average of 43.5 reflects conservative scoring on legacy and longevity that will change as these films age. KPop Demon Hunters leads the decade at 77.8 — a streaming-first film with an F1 of 83.0 and a D6 of 72, the highest cultural footprint score of any post-2015 film in the index, its phenomenon operating in ways that bypass traditional critical infrastructure entirely. Oppenheimer at 70.3 is the most conventionally significant film of the decade so far: a three-hour historical drama that generated genuine cultural conversation, D4 currently at 72 and likely to rise. Everything Everywhere All at Once at 63.6 has the decade's lowest volatility at 2.2 — the three frameworks agree on its position with unusual consistency for a film this recent. The 2020s superhero entries cluster at the decade's most contested end: Thor: Love and Thunder (vol: 15.0) and Red Notice (vol: 13.6) both showing F1 scores 20+ points above F2 and F3. The decade's story is not yet written. The framework is ready for when it is.`
    }
  };
