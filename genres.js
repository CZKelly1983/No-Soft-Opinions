...
(function () {
  ...
  const GENRE_NOTES = {
    'Drama':       { note: 'The index\'s largest genre at 303 films — by volume and by average score. Drama is the genre most rewarded by the framework\'s Long View emphasis, its films most likely to accumulate critical reassessment over time. Leads the index on F2 Filmmaker average.' },
    ...
    'Western':     { note: '28 films, and the genre most visibly affected by the dataset\'s period bias. The great Westerns of the 1950s and 1960s score strongly on D4 and D5; the genre\'s decline in commercial viability after the 1970s is legible in the data.' },
    'Horror':      { note: 'Thirty-three films — still underrepresented relative to its influence, but growing. Psycho, The Shining, and Jaws cluster near the top; Sinners (2025) enters as the highest-ranked new horror film in the dataset. The genre\'s D5 Filmmaker Influence scores are disproportionately high relative to its critical recognition history. Horror invented more formal grammar than the dataset captures.' },
    'Sports':      { note: 'Fourteen films anchored by Rocky and Raging Bull, with Marty Supreme and F1 the newest additions. Sports drama rewards the framework\'s D2 Audience Devotion weighting — these are films people watch repeatedly and emotionally. Rocky\'s F1 of 75.2 is the highest Popular Verdict in the genre.' },
    'Documentary': { note: 'Fourteen films — still the most significant underrepresentation by volume relative to the genre\'s influence. Man with a Movie Camera scores D5 of 90, among the highest in the index. The genre\'s structural absence is documented fully on the dataset page. Nine of the fourteen were added by hand after the methodology missed them; the vast majority of significant documentary work is still not here.' },
